            ...
            <form
              ...
              <div class="mb-3">
                ...
                <textarea
                  ...
                  name="description"
                  rows="4"
                  placeholder="Briefly describe the project scope...">{{ old('description', $project->description) }}</textarea>
              ...
              <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                  ...
                  <select
                    ...
                    <option
                      value="planning"
                      {{ $currentStatus == 'planning' ? 'selected' : '' }}>
                      Planning
                    </option>
                    ...
                    <option
                      value="review"
                      {{ $currentStatus == 'review' ? 'selected' : '' }}>
                      Review
                    </option>

                    <option
                      value="complete"
                      {{ $currentStatus == 'complete' ? 'selected' : '' }}>
                      Completed
                    </option>
              ...
              <div class="mb-4">
                ...
                <select
                  ...
                  <option
                    value="{{ $user->id }}"
                    {{ old('assigned_user_id', $project->assigned_user_id) == $user->id ? 'selected' : '' }}>
                ...
                <div class="form-text">
                  Select the primary person responsible for this project.
                </div>
              ...
              <div class="mb-4">
                ...
                $project->members
                ->pluck('id')
                ->reject(fn ($id) => $id == $project->assigned_user_id)
                ->values()
                ->toArray()
                );
                @endphp
                ...
                <select
                  ...
                  @if($user->id != $project->assigned_user_id)
                ...
                <div class="form-text">
                  Select additional team members. The project lead is already part of the project team.
                </div>
